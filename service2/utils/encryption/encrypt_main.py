...
from encryption_test import udf_decrypt, udf_encrypt

spark = (
    SparkSession.builder
     #   .master("local")
        .appName("spark_encryption_decryption")
     #   .config("hive.vectorized.execution", "true")
        .enableHiveSupport()
        .getOrCreate()
)
...
spark = SparkSession.builder.appName("spark_encryption_decryption").enableHiveSupport().getOrCreate()
